...
<div class="container" id="formCrea">
    ...
    <form>
        <div class="form-group pb-sm">
            ...
            <input type="text" class="form-control" id="nomGuide" onChange="urlFonction()" name="nom du guide"
                ...
                <div id="section_exemple">
                    ...
                    <div class="form-group">
                        <button type="button" id="add_field_button"
                            class="boutonForm boutonAjouter boutonPetit ml-auto mr-auto format_slide">Ajouter une
                            slide</button>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm">
        ...
        <div class="form-group">
            <div class="form-group row">
                ...
                <div class="col-sm">
                    <button type="button" class="boutonForm boutonAjouter" id="ajout_section"
                        style="visibility: visible">Ajouter une
                        section</button>
                </div>
            </div>
            <hr>
