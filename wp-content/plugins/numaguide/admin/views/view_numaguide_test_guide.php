<div class="container">
        ...
        <form name="form" action="" method="post">
            ...
            <div class="form-group pb-sm-2">
                ...
                <input type="text" id="slide1" name="slide1" value="slide1" disabled>
...
<?php
    if(isset($_POST['ok'])){
        ...
        if(isset($_POST['slide1text-1'])) {
            ...
            if($ng_slide1_nom == 'slide3') {
                $num_cat = 53;
                $nom_slide = 'slide_3';
            }if($ng_slide1_nom == 'slide4') {
                $num_cat = 54;
                $nom_slide = 'slide_4';
            }if($ng_slide1_nom == 'slide5') {
                $num_cat = 55;
                $nom_slide = 'slide_5';
            }if($ng_slide1_nom == 'slide6') {
                $num_cat = 56;
                $nom_slide = 'slide_6';
            }if($ng_slide1_nom == 'slide10') {
                $num_cat = 60;
                $nom_slide = 'slide_10';
            }if($ng_slide1_nom == 'slide11') {
                $num_cat = 61;
                $nom_slide = 'slide_11';
        ...
        if(isset($_POST['slide2text-1']) & isset($_POST['slide2text-2'])) {
            ...
            if($ng_slide1_nom == 'slide7') {
                $num_cat = 57;
                $nom_slide = 'slide_7';
            }if($ng_slide1_nom == 'slide8') {
                $num_cat = 58;
                $nom_slide = 'slide_8';
            }if($ng_slide1_nom == 'slide13') {
                $num_cat = 63;
                $nom_slide = 'slide_13';
            }if($ng_slide1_nom == 'slide14') {
                $num_cat = 64;
                $nom_slide = 'slide_14';
            }if($ng_slide1_nom == 'slide16') {
                $num_cat = 66;
                $nom_slide = 'slide_16';
            }
        ...
        if(isset($_POST['slide1-1']) & isset($_POST['slide1-2']) & isset($_POST['slide1-3'])) {
        ...
        if(isset($_POST['slide5text-1']) & isset($_POST['slide5text-2']) & isset($_POST['slide5text-3']) & isset($_POST['slide5text-4']) & isset($_POST['slide5text-5'])) {
            ...
            if($ng_slide1_nom == 'slide2') {
                $num_cat = 52;
                $nom_slide = 'slide_2';
            }if($ng_slide1_nom == 'slide18') {
                $num_cat = 68;
                $nom_slide = 'slide_18';
            }if($ng_slide1_nom == 'slide19') {
                $num_cat = 69;
                $nom_slide = 'slide_19';
            }
